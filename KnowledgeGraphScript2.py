...
_sample_data_count = -1 # set this to be -1 to use all data.
...
if __name__ == '__main__':
    ...
    _movie_info  = __load_movie_info()
    _final_gathering = True
    ...
    if _final_gathering:
        ...
        from Sessions.KG_ICF_Session import KGRecSession

        _rec_session = KGRecSession()

        _recommendation = _rec_session.recommend(
            data=_training_data, predict_user_list=_predict_user_list,
            params={'rec_length': 50, 'movie_info': _movie_info}
        )
